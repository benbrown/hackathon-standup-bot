    ...
    handler.onMessage((context, next) => __awaiter(void 0, void 0, void 0, function* () {
        if (context.activity.text) {
            ...
            if (context.activity.text.match(/^(test schedule)/i)) {
                return yield handler.triggerEvent(context, 'showScheduleCard', next);
            }
        }
        yield next();
    }));
    handler.handleEvent('showScheduleCard', (context, next) => __awaiter(void 0, void 0, void 0, function* () {
        yield context.sendActivity(ActivityFactory.createActivity(lgEngine.evaluateTemplate("ScheduleCard")));
        yield next();
    }));
};
//# sourceMappingURL=showSchedule.js.map