...
exports.default = (handler) => {
    ...
    const standupDialog = new botbuilder_dialogs_1.WaterfallDialog('STANDUP', [
        (step) => __awaiter(void 0, void 0, void 0, function* () {
            step.values['answers'] = [];
            yield step.context.sendActivity(`This is the stand-up for ${step.options['team'].name} / ${step.options['channel'].name}. Let's get started!`);
        ...
        (step) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield step.context.sendActivity('Thanks for taking the time to respond!');
