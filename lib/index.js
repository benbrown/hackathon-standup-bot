...
const bot = new handler_1.Handler(storage, adapter);
adapter.onTurnError = (context, error) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield context.sendActivity('The bot encountered an error or bug. To continue to run this bot, please fix the bot source code.');
});
